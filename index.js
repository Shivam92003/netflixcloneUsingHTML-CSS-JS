// const
const apikey ="8c29cc1c6ccd6ffe6b7a1da027c2567d";
...
function buildBannerSection(movie){
   ...
   <p class="banner_info">Trending in movie | Released - ${movie.release_date}y</p>
...
function fetchAndBuildAllSections(){
    ...
    // The catch statement allows you to define a block of code to be executed, if an error occurs in the try block. When an error occurs, JavaScript will normally stop and generate an error message. The technical term for this is: JavaScript will throw an exception (throw an error).
...
.catch(err=>console.error(err));
 ...
 function buildMoviesSection(list,categoryName){ 
   ...
   const moviesListHTML= list.map(item=>{
    ...
    // append html into moviews container
...
//  function MoviesSection(list,categoryName){ 
//     console.log(list,categoryName);
...
// API Key (v3 auth)
// 8c29cc1c6ccd6ffe6b7a1da027c2567d
// Example API Request
// https://api.themoviedb.org/3/movie/550?api_key=8c29cc1c6ccd6ffe6b7a1da027c2567d



// API Read Access Token (v4 auth)
// eyJhbGciOiJIUzI1NiJ9.eyJhdWQiOiI4YzI5Y2MxYzZjY2Q2ZmZlNmI3YTFkYTAyN2MyNTY3ZCIsInN1YiI6IjY0MWZjNjU5YzJmNDRiMDBhMGZiMjljYyIsInNjb3BlcyI6WyJhcGlfcmVhZCJdLCJ2ZXJzaW9uIjoxfQ.V8oZA_3L93cOSkdcK6Iz4sufG2fCG-mQ8nmhmqkPfEo